package app.sample.stockfishApi;
...
public class Stockfish {
    ...
    private Stockfish() {
        try {
            ProcessBuilder pb = new ProcessBuilder(System.getProperty("user.dir").replace('\\','/') + "/src/" + "app/sample/stockfishApi/resources/stockfish_13_win_x64.exe");
            myProcess = pb.start();
